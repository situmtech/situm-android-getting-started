...
public class BuildingListActivity extends AppCompatActivity implements BuildingListAdapter.BuildingListAdapterOnClickHandler{
    ...
    public void onClick(String eventClick) {
        ...
        Intent intent = new Intent(this, GetBuildingEvents.class);
