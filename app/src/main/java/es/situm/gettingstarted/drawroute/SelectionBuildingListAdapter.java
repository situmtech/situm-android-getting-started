...
public class SelectionBuildingListAdapter extends RecyclerView.Adapter<SelectionBuildingListAdapter.BuildingListViewHolder> {
    ...
    public SelectionBuildingListAdapter(BuildingListAdapterOnClickHandler handler){
    ...
    public BuildingListViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        return new SelectionBuildingListAdapter.BuildingListViewHolder(view);
    }
