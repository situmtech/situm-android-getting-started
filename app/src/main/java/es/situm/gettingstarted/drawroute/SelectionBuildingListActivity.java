...
public class SelectionBuildingListActivity extends AppCompatActivity implements SelectionBuildingListAdapter.BuildingListAdapterOnClickHandler{
    private static final String TAG = SelectionBuildingListActivity.class.getSimpleName();

    private RecyclerView mRVBuildingList;
    private TextView mErrorMessage;
    private ProgressBar mProgressBar;

    private SelectionBuildingListAdapter adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SelectionBuildingListAdapter(this);
